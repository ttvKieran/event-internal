...
public class PaymentProvider {
    ...
    public static PaymentProvider of(String code) {
        if (code == null) throw new IllegalArgumentException("Cổng thanh toán không được trống");
        return switch (code.toUpperCase()) {
            case "VNPAY" -> VNPAY;
            case "MOMO"  -> MOMO;
            default -> throw new IllegalArgumentException("Cổng thanh toán không hợp lệ: " + code);
        };
    }
}
