...
public class RegistrationKafkaListener {
    ...
    public void onRegistrationEvent(ConsumerRecord<String, String> record) {
        try {
            ...
            switch (eventType) {
                case "RegistrationConfirmedEvent" -> {
                    RegistrationConfirmedMessage msg =
                        objectMapper.readValue(actualPayload, RegistrationConfirmedMessage.class);
                    notificationUseCase.handleRegistrationConfirmed(msg);
                }
                case "PaidRegistrationRolledBackEvent" -> {
                    PaidRegistrationRolledBackMessage msg =
                        objectMapper.readValue(actualPayload, PaidRegistrationRolledBackMessage.class);
                    notificationUseCase.handlePaidRegistrationRolledBack(msg);
                }
