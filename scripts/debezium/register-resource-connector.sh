...
CONNECTOR_NAME=${CONNECTOR_NAME:-resource-outbox-connector}
DB_HOST=${DB_HOST:-resource-db}
DB_PORT=${DB_PORT:-5432}
DB_USER=${DB_USER:-postgres}
DB_PASSWORD=${DB_PASSWORD:-postgres}
DB_NAME=${DB_NAME:-resource_db}
TOPIC_PREFIX=${TOPIC_PREFIX:-vtit}
TABLE_INCLUDE_LIST=${TABLE_INCLUDE_LIST:-public.outbox_events}
ROUTE_TOPIC_REPLACEMENT=${ROUTE_TOPIC_REPLACEMENT:-Resource}
...
echo "Đăng ký Connector cho Resource Service..."
...
echo -e "\nHoàn thành đăng ký Connector cho Resource Service"
