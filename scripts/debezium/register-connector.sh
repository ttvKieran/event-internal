...
CONNECTOR_NAME=${CONNECTOR_NAME:-event-outbox-connector}
DB_HOST=${DB_HOST:-event-db}
DB_PORT=${EVENT_DB_PORT:-5432}
TOPIC_PREFIX=${TOPIC_PREFIX:-vtit}
TABLE_INCLUDE_LIST=${TABLE_INCLUDE_LIST:-public.outbox_events}
ROUTE_TOPIC_REPLACEMENT=${ROUTE_TOPIC_REPLACEMENT:-Event}
